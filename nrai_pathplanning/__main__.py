...
from .code import process_imu, process_pose
...
def parse_args() -> ArgumentParser:
    parser = ArgumentParser(description="nrai-pathplanning")
...
def process_msg(topic: str, timestamp: float, msg: object) -> object:
    if topic == "/zed/zed_node/pose":
        return process_pose(msg)
    if topic == "/zed/zed_node/imu/data":
        return process_imu(msg)
    return
